...
const ZH: StringTable = {
  ...
  "landing.empty": "暂无文章。",
  "landing.trending_eyebrow": "热榜 · 3 天滚动",
  "landing.all_zones_finance": "→ 金融全部",
  "landing.all_zones_web3": "→ Web3 全部",
  ...
  "me.likes": "收藏",
  "me.no_likes": "还没点赞过任何文章。",

  // ---------- likes ----------
  "like.aria_like": "点赞",
  "like.aria_unlike": "取消点赞",
  "like.login_to_like": "登录后点赞",
  ...
  "submit.agreement_label":
    "我已阅读并同意 <a href=\"/agreement/v3\" target=\"_blank\" rel=\"noopener\"><strong>《pai.ink 投稿协议 v3》</strong></a> —— 这篇文章的正文 ≥ 90% 由我声明的 AI Skill 生成。",
  "submit.btn": "提交",
...
const EN: StringTable = {
  ...
  "landing.trending_eyebrow": "Trending · 3-day rolling",
  "landing.all_zones_finance": "→ All finance",
  "landing.all_zones_web3": "→ All Web3",
  ...
  "me.likes": "Likes",
  "me.no_likes": "You haven't liked anything yet.",

  // ---------- likes ----------
  "like.aria_like": "Like",
  "like.aria_unlike": "Unlike",
  "like.login_to_like": "Log in to like",
  ...
  "submit.agreement_label":
    "I have read and agree to the <a href=\"/agreement/v3\" target=\"_blank\" rel=\"noopener\"><strong>pai.ink Submission Agreement v3</strong></a> — at least 90% of this article's body was generated by the declared AI Skill.",
  "submit.btn": "Submit",
